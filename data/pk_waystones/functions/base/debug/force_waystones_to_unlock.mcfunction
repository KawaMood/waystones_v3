#> pk_waystones:base/debug/force_waystones_to_unlock
...
tag @e[type=marker,tag=pk.waystones.waystone.controller,tag=pk.custom_block.locked.in_use] remove pk.custom_block.locked.in_use