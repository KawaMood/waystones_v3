...
data modify storage pk:common temp.gui.item set value {Slot:21b,id:"minecraft:leather_helmet",Count:1b,tag:{Trim:{material:"minecraft:copper",pattern:"minecraft:sentry"},display:{Name:'[{"text":"Visibility: ","italic":false},{"text":"Private","color":"red","italic":false}]',color:13200001},HideFlags:255,CustomModelData:11130063,pk_data:{gui:1b,from:"waystones",trigger:"visibility/change",trigger_params:{allowed:1b}}}}
