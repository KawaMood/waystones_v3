...
# - (Private is allowed) & (Discover is disallowed): Set to Private
execute unless score $pk.waystones.permissions.change.visiblity.private pk.value matches 0 if score $pk.waystones.permissions.change.visiblity.discover pk.value matches 0 run scoreboard players set $next_visibility pk.temp 2
# - Discover is allowed: Set to Discover
execute unless score $pk.waystones.permissions.change.visiblity.discover pk.value matches 0 run scoreboard players set $next_visibility pk.temp 3
