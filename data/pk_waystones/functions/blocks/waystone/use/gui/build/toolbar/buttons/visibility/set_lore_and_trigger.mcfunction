...
execute if score $next_visibility pk.temp matches 0 run data modify storage pk:common temp.gui.item.tag.pk_data.trigger_params.allowed set value 0b
...
execute if score $next_visibility pk.temp matches 1 run data modify storage pk:common temp.gui.item.tag.pk_data.trigger_params.visibility set value "public"
# If Private
...
execute if score $next_visibility pk.temp matches 2 run data modify storage pk:common temp.gui.item.tag.pk_data.trigger_params.visibility set value "private"
# If Discover
...
execute if score $next_visibility pk.temp matches 3 run data modify storage pk:common temp.gui.item.tag.pk_data.trigger_params.visibility set value "discover"