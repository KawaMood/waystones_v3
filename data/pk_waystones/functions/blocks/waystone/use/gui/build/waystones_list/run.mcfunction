...
execute if score $gui.page pk.temp matches ..1 run function pk_waystones:blocks/waystone/use/gui/build/filler_item/set_regular {slot:18,custom_model_data:16110069}
execute if score $gui.page pk.temp >= $gui.last_page pk.temp run function pk_waystones:blocks/waystone/use/gui/build/filler_item/set_regular {slot:26,custom_model_data:16110069}