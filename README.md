...
In order to embellish your experience, a **resources pack** providing models for Waystones items and GUI has been made by our graphist-artist contributor, **Lordphiphi**. You can download it from here: [Waystones Resources Pack V.2.4 (for Waystones V.3) - by Lordphiphi](https://mc.kawamood.com/resourcespacks/Waystones_Resources_Pack_V.2.4_for_Waystones_V.3.zip).
...
However, a **resources pack** providing models for Waystones items and a better GUI has been made by our graphist-artist contributor, **Lordphiphi**. You can download it from here: [Waystones Resources Pack V.2.4 (for Waystones V.3) - by Lordphiphi](https://mc.kawamood.com/resourcespacks/Waystones_Resources_Pack_V.2.4_for_Waystones_V.3.zip).
</details>
